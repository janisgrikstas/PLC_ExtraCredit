...
public class Lexer {
    ...
    public ArrayList<Token> lexYay() {
        ...
        for (String word : words) {
            ...
            if(word.trim().startsWith("ignoreuntil")){
               currentlyInComment = true;
               continue;
            }
            
            if(word.trim().startsWith("untilhere") && currentlyInComment) {
            ...
            if (realLiteralMatcher.matches()) {
                lexies.add(new Token("decimal_lit", 1)); 
            }
